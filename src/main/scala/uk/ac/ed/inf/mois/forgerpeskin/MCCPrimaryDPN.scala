...
class MCCPrimaryDPN extends DeterministicReactionNetwork[Double, Double] with Apache with VarCalc {
  ...
  val PtppCRo = Species("c:PtppCRo") default(0)
  ...
  val C = Species("c:C") default(6.633477)
